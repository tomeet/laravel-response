...
In `app/Exceptions/Handler.php` file `use Tomeet\Response\Laravel\Support\Traits\ExceptionTrait;`

In `app/Http/Controllers/Controller.php` file `use Tomeet\Response\Laravel\Support\Traits\ExceptionTrait;`
